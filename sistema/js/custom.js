...
function validaCadastro(evt){
	...
	var data_agendamento = document.getElementById('data_agendamento');
...
/*
function confirmaExclusao(excluir,id_cpf,data,hora){
//function confirmaExclusao(data_agendamento){
	retorno = confirm("Deseja excluir esse Registro?")
	...
	if (retorno){
	    ...
	    form.action = "action_agendar.php";
	    form.method = "post";
